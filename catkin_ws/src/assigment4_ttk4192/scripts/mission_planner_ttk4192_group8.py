...
def main_hybrid_a(heu,start_pos, end_pos,reverse, extra, grid_on, cell_size=0.25):
...
def move_robot(start_pos, end_pos, experiment=False, cell_size=0.25):
    if experiment:
...
def task6b():
    ...
    for i, point in enumerate(points):
        ...
        start_pos = point
        end_pos = points[i+1]
        move_robot(start_pos=start_pos, end_pos=end_pos, cell_size=1)
       ...
       #Here you must run your AI planner module
        ...
        while i_ini < task_total:
            ...
            if plan_temp[0]=="picture":
                ...
                print(f"Could not find an action: ")
                raise
